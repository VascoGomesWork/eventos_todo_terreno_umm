        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <ol className="breadcrumb mb-4">
                    <li className="breadcrumb-item active">Selecione a localização do evento utilizando as caixas de texto abaixo
                    </li>
                </ol>
                ...
                <div className="google-map-code">
                    ...
                    {/* Sem Direções */}
                    {localidadeInicioEvento === "" && localidadeFimEvento === "" && <iframe src="https://www.google.com/maps/d/u/1/embed?mid=1YTPHNr4FUDJaMfo5GaZfzxdyX3QFfu8&ehbc=2E312F" width="640" height="480"></iframe>}
                    ...
                    {(localidadeInicioEvento === "1" && localidadeFimEvento === "Vila Nova de Famalicão") && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1f_eogbXTPA_UTrKmjtz2VaUTUdWh-Fs&ehbc=2E312F" width="640" height="480"></iframe>}

                    { /* Alcácer do Sal - Beja */}
                    {localidadeInicioEvento === "2" && localidadeFimEvento === "Beja" && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1_HExvO_60ynv_YA787K4SCNYL_4zwxk&ehbc=2E312F" width="640" height="480"></iframe>}

                    { /* Beja - Quarteira */}
                    {localidadeInicioEvento === "3" && localidadeFimEvento === "Quarteira" && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1aDUpSKap8MJLYDQWqkZGNhDxseCOboM&ehbc=2E312F" width="640" height="480"></iframe>}

                    { /* Sagres - Faro */}
                    {localidadeInicioEvento === "4" && localidadeFimEvento === "Faro" && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1Vn01dlRfQ23uy5Yn-NUI87X1aVMkOSU&ehbc=2E312F" width="640" height="480"></iframe>}

                    { /* Ponta de Sol - Ponta de São Lourenço */ }
                    {localidadeInicioEvento === "5" && localidadeFimEvento === "Ponta de São Lourenço(Madeira)" && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1qTaGmcJPAY9J6HtRDK7MTKuWzM2O1MI&ehbc=2E312F" width="640" height="480"></iframe>}

                    { /* Ponta de Sol - Poça das Lesmas, Seixal */}
                    {localidadeInicioEvento === "6" && localidadeFimEvento === "Poça das Lesmas, Seixal(Madeira)" && <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1fAJQwTlCA383VSmemOj5JHfez9OYfDg&ehbc=2E312F" width="640" height="480"></iframe>}
                    <br/>

                    <label htmlFor="cars">Localidade Inicio:</label>
                    ...
                    <label htmlFor="cars">Localidade Fim:</label>
